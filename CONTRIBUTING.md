...
Both open an issue on `omacom/omarchy-plugin-marketplace`. A maintainer reviews it. Approval binds to one exact commit, and it is a listing check, not a security audit.
